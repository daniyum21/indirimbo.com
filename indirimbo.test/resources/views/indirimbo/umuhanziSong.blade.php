...
<div class="hero-unit jumbotron" style="margin-right:2em">
    ...
    <span><a href="/umuhanzi/{!!str_slug($umuhanzi->StageName)!!}/{!! $umuhanzi->UUID !!}"> < Umuhanzi {!!$umuhanzi->StageName!!} > </a></span>
        <br><br>
...
{{--            <a href="{!! route('indirimbo.edit',['$SongID'=>$indirimbo->UUID]) !!}">Edit Song</a>--}}
