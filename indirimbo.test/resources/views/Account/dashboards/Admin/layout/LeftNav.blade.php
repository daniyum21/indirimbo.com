<aside id="sidebar_left" class="nano nano-light affix">
    <!--Navbar Branding-->
    <div class="navbar-branding"><a href="{{route('Dashboard')}}" class="navbar-brand"><span class="text-white">{{ Auth::user()->FirstName}}</span> Admin</a><span id="toggle_sidemenu_l" class="ad ad-lines"></span></div>
    ...
    <div class="sidebar-left-content nano-content">
        ...
        <header class="sidebar-header">
            ...
            <div class="sidebar-widget author-widget">
                <div class="media"><a href="#" class="media-left"><img src="/css/assets/img/avatars/3.jpg" class="img-responsive"></a>
                    <div class="media-body">
                        <div class="media-links"></div>
                        <div class="media-author">{{ Auth::user()->FirstName}}  {{Auth::user()->LastName  }}</div><a href="#" class="sidebar-menu-toggle">User Menu</a><a href="{{route('Logout')}}">Logout</a>
                    </div>
                </div>
            </div>
            ...
            <div class="sidebar-widget menu-widget">
                <div class="row text-center mbn">
                    ...
                    <div class="col-xs-4"><a href="/admin/profile" data-toggle="tooltip" data-placement="top" title="Profile" class="text-alert"><span class="fa fa-asterisk"></span></a></div>
                </div>
                <div class="row text-center mbn">
        ...
        <ul class="nav sidebar-menu">
            ...
            <li class="active"><a href="{{route('Dashboard')}}"><span class="glyphicon glyphicon-home"></span><span class="sidebar-title">Dashboard</span></a></li>
            <li class="sidebar-label pt15">Manage</li>
            <li class="sidebar-proj"><a href="#projectOne"><span class="fa fa-bookmark text-primary"></span><span class="sidebar-title">Products</span></a></li>
